...
function Comments() {
  ...
  const [wordFrequency, setWordFrequency] = useState<{ name: string; value: number }[]>([])
  ...
  useEffect(() => {
    ...
    import(`@renderer/data/${search}.json`)
      .then((jsonData) => {
        ...
        // Convert wordCount object to an array and sort by frequency
        const wordFrequencyData = Object.entries(wordCount)
          .map(([name, value]) => ({ name, value }))
          .sort((a, b) => b.value - a.value) // Sort by occurrences in descending order
          .slice(0, 7) // Limit to top 7 words
  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex flex-row gap-5">
        ...
        <KeywordCloud data={wordFrequency} />
      </div>
